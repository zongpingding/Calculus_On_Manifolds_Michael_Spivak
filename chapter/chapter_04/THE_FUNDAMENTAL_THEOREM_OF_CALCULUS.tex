\newpage
\section{THE FUNDAMENTAL THEOREM OF CALCULUS}\index{Fundamental Theorem of Calculus|(}
...
\begin{problems}
    ...
    \problem{(\textbf{A first course in complex variables.}\index{Function!differentiable})\index{Complex variables} 
        If $f: \F{C}\to \F{C}$, define $f$ to be \textbf{differentiable}\index{Differentiable function} at $z_0\in \F{C}$ if 
        the limit
        \begin{align*}
