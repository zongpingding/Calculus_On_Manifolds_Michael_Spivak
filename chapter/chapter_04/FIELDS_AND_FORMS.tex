...
If $f\colon{}\F{R}^n\to \F{R}^n$ is differentiable, then $\R{D}f(p)\in\Lambda^1(\F{R}^n)$. 
...
\begin{problems}
    \problem{
        \begin{enumerate}[label=\upshape{(\alph*)}]
            \item If $f\colon{}\F{R}^n\to\F{R}^m$ and $g\colon{}\F{R}^m\to \F{R}^p$, show that 
                $(g\circ f)_* = g_*\circ f_*$ and $(g\circ f)^* = f^*\circ g^*$.
            \item If $f,g\colon{}\F{R}^n\to \F{R}^n$, show that $\dd(f\cdot g) = f\cdot \dd g + g\cdot \dd f$.
        \end{enumerate}
    }
    \problem{
        ...
        as $c_*((e_1)_t) = ((c^1)'(t), \cdots, (c^n)'(t))_{c(t)}$. If $f\colon{}\F{R}^n\to\F{R}^m$,
        show that the tangent vector to $f\circ c$ at $t$ is $f_*(v)$.
    }
    \problem{
        Let $f\colon{}\F{R}\to \F{R}$ and define $c:\F{R}\to\F{R}^2$ by $c(t) = (t,f(t))$. Show
    ...
    \problem{
        If $f\colon{}\F{R}^n\to\F{R}^n$, define a vector field $\mathbf{f}$ by $\mathbf{f}(p) = f(p)_p\in\F{R}^n_p$.
        \begin{enumerate}[label=\upshape{(\alph*)}]
            \item Show that every vector field $F$ on $\F{R}^n$ is of the form $\B{f}$ for some $f$.
            \item Show that $\div \mathbf{f} = \trace f'$.
        \end{enumerate}
    }
    \problem{
        If $f\colon{}\F{R}^n\to\F{R}$, define a vector field grad $f$ by 
        \begin{align*}
    ...
    \problem{
        ...
        \begin{enumerate}[label=\upshape{(\alph*)}]
            ...
            \item If $F$ is a vector field on a star-shaped open set $A$ and
                $\curl F = 0$, show that $F = \grad f$ for some function $f\colon{}A\to \F{R}$.
                Similarly, if $\div F = 0$, show that $F = \curl G$ for some vector
                field $G$ on $A$.
        \end{enumerate}
    }
    \problem{
        Let $f\colon{}U\to\F{R}^n$ be a differentiable function with a differentiable
        inverse $f^{-1}\colon{} f(U)\to\F{R}^n$. If every closed form on $U$ is exact, show
