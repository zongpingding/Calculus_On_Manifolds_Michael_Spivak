...
Finally we define the boundary\index{Boundary!of a chain} of an $n$-chain $\sum_{}^{}{a_ic_i}$ by 
\begin{align*}
...
\begin{problems}
    \problem{
        ...
        An $n$-\textbf{chain}\index{Chain} is a function $f:\C{S}\to \B{Z}$ such that $f(c)=0$
