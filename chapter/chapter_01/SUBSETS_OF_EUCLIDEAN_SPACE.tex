...
This is the \textbf{closed rectangle}\Index{Close set}\index{Rectangle (closed or open)} $[a,b]\times [c,d]$, 
...
is called $open$(\figref{Fig 1-1})\index{Open set} if for each $x\in U$ there is an open 
