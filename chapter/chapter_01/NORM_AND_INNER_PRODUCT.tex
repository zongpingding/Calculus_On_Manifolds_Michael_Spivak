\section{NORM AND INNER PRODUCT}\index{Inner product}
...
called the \textbf{Norm} absolute value\Index{Absolute value}\index{Normal} $|x|$ of $x$ and 
...
denoted simply 0. The usual basis\index{Basis, usual for $\F{R}^n$} of $\F{R}^n$ is $e_1, \cdots, e_n$, 
...
\begin{problems}
    ...
    \problem{The quantity $|y-x|$ is called the distance\index{Distance} between $x$ and $y$.Prove and 
