...
\begin{problems}
    ...
    \problem{
        An \textbf{absolute $k$-tensor}\index{Absolute tensor} on $V$ is a function $\eta:V^k\to \F{R}$ of the 
        form $|\omega|$ for $\omega\in\Lambda^k(V)$. An \textbf{absolute $k$-form}\index{Absolute differential form}  
