...
This unit vector is called the \textbf{outward unit normal}\index{Unit outward normal}\index{Outward unit normal} $n(x)$; it is not hard to check that this
...
\textbf{induced orientation}\index{Orientation!induced}\index{Induced orientation}. If we apply these definitions to $\F{H}^k$ with the usual orientation, 
