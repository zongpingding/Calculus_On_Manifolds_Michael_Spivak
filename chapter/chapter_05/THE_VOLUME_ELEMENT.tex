...
\begin{problems}
    ...
    \problem{
        \begin{enumerate}[label=(\alph*)]
            \item If $f\colon{} [a,b]\to \F{R}$ is non-negative and the graph of $f$ in the
    ...
    \problem{
        \begin{enumerate}[label=(\alph*)]
            \item If $f\colon{}[0,1]\to \F{R}$ is differentiable and $c:[0,1]\to \F{R}^2$ is defined
    ...
    \problem{
        Let $f,g\colon{}[0,1]\to\F{R}^3$ be the nonintersecting closed curves. Define the \textbf{linking number}\index{Linking number} 
