...
\begin{problems}
    ...
    \problem{Find the partial derivatives of the following functions (where $g\colon{}\F{R}\to \F{R}$ is continuous):\vspace*{-1em}
        \begin{multicols}{2}
        \begin{enumerate}[label={\upshape(\alph*)}]
    ...
    \problem[*]{Let $g_1,g_2:\F{R}^2\to \F{R}$ be conttinuous. Define $f\colon{}\F{R}^2\to \F{R}$ by 
            \begin{align*}
            ...
            \begin{enumerate}[label={\upshape(\alph*)}]
                ...
                \item Find a function $f\colon{}\F{R}^2\to \F{R}$ such that $\R{D}_1f(x, y) = x$ and 
                    $\R{D}_2f(x, y)$ $=y$. Find one such that $\R{D}_1f(x, y) = y$ and $\R{D}_2f(x, y) = x$.
            \end{enumerate}
        }
    \problem[*]{If $f\colon{}\F{R}^2\to \F{R}$ and $\R{D}_2f = 0$, show that $f$ is independent of the second variable.
        If $\R{D}_1f = \R{D}_2f = 0$, show that $f$ is constant.}
    \problem[*]{Let $A = \{(x, y)\in \F{R}^2: x<0,\text{ or } x\ge 0\text{ and } y\neq 0\}$.
            \begin{enumerate}[label={\upshape(\alph*)}]
                \item If $f\colon{}A\to \F{R}$ and $\R{D}_af = \R{D}_2f = 0$, show that $f$ is constant 
                    \textit{Hint:} Note that any two points in $A$ can be connected by a sequence 
                    of lines each parallel to one of the axes.
                \item Find a fucntion $f\colon{}A\to \F{R}$ such that $\R{D}_2f = 0$ but $f$ is not independent
                    of the second variable. 
            \end{enumerate}
        } 
    \problem{Define $f\colon{}\F{R}^2\to \F{R}$ by 
            \begin{align*}
    ...
    \problem[*]{ Define $f\colon{}\F{R}\to \F{R}$ by 
            \begin{align*}
                f(x, y) = \left\{\begin{aligned}
                    & \mathrm{e}^{-x^{-2}} && x \neq 0, \\
                    & 0 && x = 0.
    ...
    \problem[*]{Let 
            ...
            \end{align*}
            \begin{enumerate}[label={\upshape(\alph*)}]
                \item Show  that $f\colon{}\F{R}\to \F{R}^2$ is a $C^\infty$ function which is positive 
    ...
    \problem{Define $g, h\colon{}\{x\in \F{R}^2: |x|\le 1\} \to \F{R}^2$ by 
            \begin{align*}
