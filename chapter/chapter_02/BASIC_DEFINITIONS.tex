\section[\textsc{basic definitins}]{BASIC DEFINITIONS}
Recall that a function $f\colon{}\F{R} \to \F{R}$ is differentiable\index{Differentiable function} at $a\in \F{R}$
...
A function $f\colon{}\F{R} \to \F{R}$ is differentiable\index{Differentiable function} at $a\in \F{R}$
...
\begin{problems}
    \problem[*]{Prove that if $f\colon{}\F{R}^n\to \F{R}^m$ is differentiable at
        $a \in \F{R}^m$, then it is continuous at $a$. \textit{Hint:} Use Problem 1-10.}
    \problem{A function $f\colon{}\F{R}^2 \to \F{R}$ is \textbf{independent of the second variable}\index{Variable!independent of the second}
        ...
        function $g\colon{}\F{R}\to \F{R}$ such that $f(x,y) = g(x)$. What is $f'(a,b)$ in
        terms of $g'$?}
    \problem{Define a function $f\colon{}\F{R}^2 \to \F{R}$ is independent of the first\index{Variable!independent of the first} 
    ...
    \problem{Let $g$ be a continuous real-valued function on the unit circle $\{x\in \F{R}^2:|x|=1\}$ 
        such that $g(0, 1) = g(1, 0) = 0$ and $g(-x) = -g(x)$. Define $f\colon{}\F{R}^2\to \F{R}$ by 
        \begin{align*}
            f(x) = 
            \left\{\begin{aligned}
        ...
        \begin{enumerate}[label={\upshape(\alph*)}]
            \item If $x\in \F{R}^2$ and $h\colon{}\F{R}\to \F{R}$ is defined by $h(t) = f(tx)$, show that $h$ is differentiable.
    ...
    \problem{Let $f\colon{}\F{R}^2 \to \F{R}$ be defined by 
            \begin{align*}
                f(x, y) = 
                \left\{\begin{aligned}
    ...
    \problem{Let $f\colon{}\F{R}^2\to \F{R}$ be defined by $f(x, y) = \sqrt{|xy|}$. Show that $f$ is not differentiable at (0, 0).}
    \problem{Let $f\colon{}\F{R}^2\to \F{R}$ be a function such that $|f(x)|\le |x|^2$. Show that $f$ is differentiable at 0.}
    \problem{Let $f\colon{}\F{R}^2\to \F{R}$. Prove that $f$ is differentiable at $a\in \F{R}$ if and only if $f^1$ and $f^2$ 
    ...
    \problem{Two functions $f,g\colon{} \F{R}\to \F{R}$ are \textbf{equal up to $n$th order}\index{Equal up to $n$th order} at $a$ if and only if 
            \begin{align*}
