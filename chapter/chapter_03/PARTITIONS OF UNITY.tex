...
\begin{problems}
    \problem{
        ...
        \item Suppose that $f:(0,1)\to\F{R}$ is a non-negative continuous function. 
            Show that $\int_{(0,1)}f$ exists if and only if 
            $\lim_{\varepsilon\to 0}\int_\varepsilon^{1-\varepsilon}f$ exists.
        \item Let $A_n = [1-1/2^n,1-1/2^{n+1}]$. Suppose that $f:(0,1)\to \F{R}$ satisfies
    ...
    \problem{
        Let $A_n$ be a closed set contained in $(n, n+1)$. Suppose that $f:\F{R}\to \F{R}$
