...
\begin{problems}
    ...
    \problem{
        Let $f:[a,b]\to \F{R}$ be integrable and non-intergrable and let $A_f = \{
        (x, y):a\le x\le b\text{ and } 0\le y\le f(x)\}$. Show that $A_f$ is Jordan-measurable
        and has area $\int_a^b f$.
    }
    \problem{
        If $f:[a, b]\times [a, b]\to \F{R}$ is continuous, show that 
        \begin{align*}
    ...
    \problem{
        If $A=[a_1, b_1]\times \cdots \times [a_n,b_n]$ and $f:A\to \F{R}$ is continuous, 
        define $F:A\to \F{R}$ by 
        \begin{align*}
    ...
    \problem[*]{
        Let $f:[a, b]\times [c,d]\to \F{R}$ be continuous and suppose $\R{D}_2f$ is continuous.
        Define $F(y)=\int_a^bf(x, y)\;\dd x$. Prove \textit{Leibnitz's rule}: 
    ...
    \problem{
        If $f:[a,b]\times [c,d]\to \F{R}$ is continuous and $\R{D}_2f$ is continuous, define 
    ...
    \problem[*]{
        \begin{enumerate}[label=(\alph*)]
        \item Let $g:\F{R}^n\to\F{R}^n$ be linear transformation of one of the following types:
            \begin{align*}
                & \left\{\begin{aligned}
                    & g(e_i) = e_i, i\neq j \\
                    & g(e_j) = ae_j
        ...
        \item Prove that $|\det g|\cdot v(U)$ is the volume of $g(U)$ for any linear transformation 
            $g:\F{R}^n\to\F{R}^n$. \textit{Hint:} If $\det g\neq 0$, then $g$ is the 
            composition of linear transformations of the types considering in (a).
    \end{enumerate}
    }
    \problem{
        (Cavalieri's principle) Let $A$ and $B$ be Jordan-measurable sets in $\F{R}^3$.
